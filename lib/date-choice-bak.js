							...
							if(!$(".date_click").length) {
								...
								$(".date_click .year_month select").change(function() {
							                ...
							                if(set_json.today_start == "yes" &&$(this).hasClass("year")){
							                	...
							                	{
							                		var end_time=stringTotime(dom.attr("startdom_maxdate"))-set_json.startToend_days*24*60*60*1000;
//							                	    if(new Date($(this).val(),0,1).valueOf()<=todayTime())
//							                	    { 
//							                	    	var start_month=date_obj.getMonth()+1;
//							                	    }else{
//							                	    
//							                	    	var start_month=1;
//							                	    }
...
//							                	    }
							                	...
							                	}else if(dom.hasAttribute("enddom_mindate"))
							                	{
							                	    ...
							                	    setMonth(ok_month[0],ok_month[ok_month.length-1]);
//							                		var start_month=stringTotime(dom.attr("enddom_mindate"))+set_json.startToend_days*24*60*60*1000;
//                                                  var item_start_time=start_month;
//							                	    if(new Date($(this).val(),0,1).valueOf()<start_month)
//							                	    {
//							                	         
//							                	    	var start_month=new Date(start_month).getMonth()+1;
//							                	    }else{
//							                	    
//							                	    	var start_month=1;
//							                	    }
...
//							                	    	
//							                	    	if( $(this).val()==new Date(item_start_time).getFullYear())
//							                	    	{
//							                	    		if($(this).val()==new Date(end_month).getFullYear())
//							                	    		{
//							                	    			setMonth(new Date(item_start_time).getMonth()+1,new Date(end_month).getMonth()+1)
//							                	    			
//							                	    		}else{
//							                	    			setMonth(new Date(item_start_time).getMonth()+1,12)
//							                	    		}
//
//							                	    	}else{
//							                	    		if($(this).val()==new Date(end_month).getFullYear())
...
//							                	    }
							                	...
							                	if(dom.hasAttribute("startdom_maxdate"))
							                	{
							                		...
							                		if($(this).val()==new Date(end_month).getFullYear())
							                		{
							                			 var end_month=new Date(end_month).getMonth()+1;
							                		     setMonth(1,end_month)
							                		}else{
							                			setMonth(1,12)
							                		}
							                		...
							                		var start_month=stringTotime(dom.attr("enddom_mindate"))+set_json.startToend_days*24*60*60*1000;
							                		if($(this).val()==new Date(start_month).getFullYear())
							                		{
