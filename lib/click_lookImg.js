...
$(function () {
    ...
    window.img_clickShow = function () {
        ...
        var dom_box = $(this);
        //};
        $(document).on('click', dom_box, function (e) {
            ...
            if (!$(".detail_look").length) {
                $('body').append('<div class="detail_look" swiper_clickLook ><em style="white-space: nowrap;"><b></b>/<i></i></em><div class="swiper-container" id="Myswiper_clickLook"><div class="swiper-wrapper"></div></div></div>');
            ...
            $(".detail_look[swiper_clickLook]").click(function () {
